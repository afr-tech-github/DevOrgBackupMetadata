({
    ...
    onToggleRoute: function(cmp, event, helper){
        var params = event.getParam('arguments');
        cmp.set('v.isRoute', params.isRoute);
    },
    ...
    onClone: function (cmp, event, helper) {        
        ...
        if(!isSelected){
        	...
        	if (!confirm(msg)) {
            	...
            	helper.onToggleSpinner(cmp);
            	var cloneQuoteline = cmp.get("c.cloneQuoteline");               
            	...
            	deleteQuoteline.setCallback(this, function (response) {
                	...
                	if (state === "SUCCESS") {
                    	...
                    	if (res) {
                        	...
                        	parent.onDelete();
                            console.log('onDelete :'+parent.onDelete());
                    	}
                	}
                	else if (state === "ERROR") {
                    	var errors = response.getError();
