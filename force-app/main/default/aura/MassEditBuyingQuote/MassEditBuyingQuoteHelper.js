({
	...
	createComponent : function(cloneCmp, quoteLine, isFirstRecord) {
		$A.createComponent(
            "c:MassEditBuyingQuoteItem", 
            { id: quoteLine.Id, 'aura:id': 'massEditBuyingQuoteItem', isFirstRecord, parent: cloneCmp},
             (massEditBuyingQuoteItem, status, errorMessage) => {
                 if (status === "SUCCESS") {
                     var body = cloneCmp.get("v.body");
                     body.push(massEditBuyingQuoteItem);
